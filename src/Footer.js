...
export default function FooterWithLogo() {
  ...
  return (
    <footer className={`w-full bg-white p-3 Theme ${theme === 'light' ? 'light-theme' : 'dark-theme'}`} >
      ...
      <div className="mt-2 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-3 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-3 text-center font-normal text-blue-gray-900 md:mb-0"
          />
      <Typography color="blue-gray" className="text-center font-normal">
        &copy; {currentYear} Currency Converter
      </Typography>



      <div className="flex gap-4 text-blue-gray-900 sm:justify-center">
            <Typography as="a" href="https://www.linkedin.com/in/viktor-trunov-0923971b7" className="opacity-80 transition-opacity hover:opacity-100">
              {/* <svg className="h-8 w-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"clip-rule="evenodd"/></svg> */}
              
              <img className="h-8 w-8 opacity-80" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" src={linkedin} alt="LinkedIn" />
            </Typography>
            
            <Typography as="a" href="https://t.me/viktortr2e3" className="opacity-80 transition-opacity hover:opacity-100">
