        ...
        <div className="md:my-6 ">
          <div className={`grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl ${theme === 'light' ? 'bg-white' : 'bg-black'} md:shadow-[5px_5px_50px_5px_rgba(60,60,60,0.3)] rounded-md text-${theme === 'light' ? 'gray' : 'white'} font-[sans-serif]`}> 
            <div>
              ...
              <p className="text-sm text-gray-400 mt-3">Do you have any idea or suggestion on how we can improve our application? Then contact us, we will be glad to hear about your proposal.</p>
              <div className="mt-12">
                ...
                <ul className="mt-3">
                  <li className="flex items-center">
                    ...
                    <a target="_blank" rel="noreferrer" href="https://veilmail.io/e/FkKh7o" className="text-[#007bff] text-sm ml-3">
                      {/* <small className="block">Mail</small> */}
                      <strong>https://viktortr2014@gmail.com</strong>
                    </a>
                  </li>
                </ul>
              </div>
